...
def pasirinkimas1():
    name = input("Įveskite knygos pavadinimą: ")
    author = input("Įveskite knygos autorių: ")
    year_made = int(input("Įveskite knygos išleidimo metus: "))
    type = input("Įveskite knygos žanrą: ")
    biblioteka.prideti_knyga(name, author, year_made, type)
